...
export default function Home() {
  const categories: CalculatorCategory[] = ["Electrical", "AC Circuits", "Electronics", "Wire & Cable", "Power System", "Motor", "Battery & Energy", "Renewable Energy", "Mechanical", "Civil", "General Science"];
      ...
      <footer className="border-t py-12 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-9 gap-8">
            ...
            <div>
              <h3 className="font-semibold mb-3">Motor</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
                {getCalculatorsByCategory("Motor").map(calc => (
                  <li key={calc.id}>
                    <a href={calc.path} className="hover:text-foreground">
                      {calc.title}
                    </a>
